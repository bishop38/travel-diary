# Приложение TravelNotes на Next.js с MongoDB и NextAuth

Данный проект разработан с использованием фреймворка Next.js версии 14 и базы данных MongoDB с помощью MongoDB Compass.
